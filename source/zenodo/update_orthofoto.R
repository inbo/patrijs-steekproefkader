...
library(zen4R)
library(tidyverse)
source_folder <- here("data", "fieldmap", "luchtfoto")
zenodo <- ZenodoManager$new(token = key_get("zenodo"), logger = "INFO")

new_version <- "2025.05"
doi <- c(
  wevl = "10.5281/zenodo.5834713", oovl = "10.5281/zenodo.5834062",
  antw = "10.5281/zenodo.5833571", limb = "10.5281/zenodo.5833264",
  vlbr = "10.5281/zenodo.5833773"
)
