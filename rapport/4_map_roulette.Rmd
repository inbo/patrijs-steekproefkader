...
Vervolgens geven ze aan of ze a) het probleem opgelost hebben, b) het probleem ondertussen reeds opgelost was, c) het probleem zich niet stelde (de OpenStreetMap data was correct), d) het probleem te moeilijk is om op te lossen.
...
Hierbij hebben we gekeken waar er grasland _sensu lato_ is volgens de landbouwgebruikpercelen (§\@ref(s:landbouw)).
...
We verwijderen tevens de smalle smalle slierten (< 5 m) die ontstaan wanneer de grenzen van verschillende kaartlagen niet perfect overlappen.
