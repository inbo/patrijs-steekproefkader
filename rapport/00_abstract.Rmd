...
The previous version of the open space map is based on the most recent publication of the biological valuation map (BWK).
Although this version of BWK was published in 2020, that does not mean that all the information was from 2020.
Actually, about three quarters of the information turned out to be older than 2007.
Hence, we are looking for a better source.
