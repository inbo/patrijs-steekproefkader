...
Daarom delen we de open ruimte van de WBE in een meerdere telblokken.
...
Eerste relatief kleine eenheden maken en die nadien samenzetten tot telblokken, laat toe een zo optimaal mogelijke indeling te maken.
...
In tabel \@ref(tab:indeling) geven we aantal welke elementen we gebruiken en in welke volgorde.
...
Na elke split zetten we de eenheden nu voldoende klein zijn afzonderlijk.
...
Mogelijk zijn in deze gebieden nog niet alle element toegevoegd aan OpenStreetMap.
...
tribble(
  ...
  "highway", "path", "veldweg niet geschikt voor landbouwvoertuigen",
    "https://wiki.openstreetmap.org/wiki/Tag:highway%3Dtrack",
  "highway", "serivce", "private toegangsweg",
...
Merk dat eenheid "E" te ver van de andere eenheden ligt.
...
Dan kunnen we door te kijken bij welke eenheden we de kleinste eenheid kunnen samenvoegen.
We kijken met welke eenheden de kleinste eenheid verbonden is.
In ons voorbeeld is "C" de kleinste eenheid en is deze verbonden met "A" en "D".
