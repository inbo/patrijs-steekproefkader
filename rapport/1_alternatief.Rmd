...
Om het verschil tussen de verschillende kaartlagen zichtbaar te maken tonen we telkens een kaart van hetzelfde ramdon gekozen gebied in Vlaanderen.
...
De lezer kan in de webversie eveneens de laag met de jachtterreinen activeren.
...
In principe zal men de kaart elke drie jaar vernieuwen.
De kaart is beschikbaar onder de [modellicentie gratis hergebruik](https://overheid.vlaanderen.be/sites/default/files/documenten/ict-egov/licenties/hergebruik/modellicentie_gratis_hergebruik_v1_0.html).
Het betreft een rasterkaart met resolutie van 10x10 m bekomen door meerdere databronnen met elkaar te combineren [@landgebruik].
