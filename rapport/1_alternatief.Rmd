...
Een belangrijke randwaarde die we stellen is dat de kaartlaag als open data beschikbaar moet zijn.
...
Om het verschil tussen de verschillende kaartlagen zichtbaar te maken geven we telkens een kaart.
Figuur \@ref(fig:basis) toont de meest recente luchtfotos van dit gebied.
We selecteerden dit gebied omdat het een inzicht geeft in de verschillen tussen de kaartlagen.
In de webversie van dit rapport zijn de kaarten interactief.
Daar kan de lezer de kaart verplaatsen naar een gebied naar eigen keuze.
De lezer kan eveneens de laag met de jachtterreinen activeren.
...
Het betreft een rasterkaart met resolutie van 1x1 m gebaseerd op zomerluchtfoto's.
...
In principe zal men de kaart elke drie jaar vernieuwen.
De kaart is beschikbaar onder de [modellicentie gratis hergebruik](https://overheid.vlaanderen.be/sites/default/files/documenten/ict-egov/licenties/hergebruik/modellicentie_gratis_hergebruik_v1_0.html).
Het betreft een rasterkaart met resolutie van 10x10 m gebaseerd door meerdere databronnen met elkaar te combineren [@landgebruik].
...
Geen enkele van kaarten uit het overige hoofdstuk is de perfecte oplossing waar we naar op zoek zijn.
...
Dit laat ons toe om voor de start van de tellingen van de voorjaarsstand van patrijs een versie van de open ruimte kaart te publiceren die gebaseerd op een recente versie van OpenStreetMap.
Tijdens de tellingen van de voorjaarsstand van patrijs kunnen jagers in het veld controleren hoe accurraat deze kaart is.
Fouten te wijten aan fouten in OpenStreetMap kunnen ze dan melden aan OpenStreetMap of zelf (laten) corrigeren.
...
En houden we bij het bepalen van de gemiddelde dichtheid van patrijs in de WBE rekening met de meest recent beschikbare informatie.
