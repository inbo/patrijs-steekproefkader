...
Wanneer we deze gebieden vergelijken met de biologische waarderingskaart [@BWK], stellen we vast dat het meerendeel van de percelen een BWK code bevatten die we vorige jaar als open ruimte beschouwden.
We kunnen ze eveneens vergelijking met de waarnemingen van de tellingen van patrijs uit het voorjaar van 2021.
...
Merk op dat deze set zowel percelen omvat die expliciet als drassig weiland aangeduid zijn en andere percelen waarbij het type `wetland` niet gespecifiëerd is.
In deze laatste groep kan een aantal percelen bevatten in de praktijk geen drassig weiland maar moeras, rietveld, ... zijn.
